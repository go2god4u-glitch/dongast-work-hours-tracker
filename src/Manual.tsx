 ...
 *  9. 색상 코드
 *  10. 테마 4종
 *  11. iPhone 홈 화면 추가 (PWA)
 *  12. Pull-to-refresh
 *  13. 관리자 사용자 추가
 *  14. 빈 입력 시각 신호
 *
 * App.tsx에서 인라인으로 가지고 있던 100여 줄을 이 파일로 분리.
 * 매뉴얼 내용 수정 시 이 파일만 편집하면 됨.
 */
export default function Manual() {
  return (
    <>
      ...
      <section>
        <h3 className="text-base font-bold mb-2">2. 헤더 동적 타이틀</h3>
        <ul className="list-disc pl-5 space-y-1">
          <li>오늘 퇴근시간 미입력 → <b>"오늘도 출근! 💪🏻"</b></li>
          <li>오늘 퇴근시간 입력 + 현재 &lt; 퇴근시간 → <b>"퇴근까지 N시간 M분 남았어요 🤗"</b> (1분마다 자동 갱신)</li>
          <li>오늘 퇴근시간 입력 + 현재 ≥ 퇴근시간 → <b>"퇴근 💕"</b></li>
        </ul>
      </section>

      <section>
        <h3 className="text-base font-bold mb-2">3. 근무 유형 5가지</h3>
      ...
      <section>
        <h3 className="text-base font-bold mb-2">4. 자동 계산 규칙</h3>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold mb-2">6. "지금 출근 / 지금 퇴근" 자동 안내</h3>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold mb-2">8. 데이터 저장</h3>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold mb-2">9. 색상 코드</h3>
        <div className="space-y-1.5">
      ...
      <section>
        <h3 className="text-base font-bold mb-2">13. 관리자 — 사용자 추가</h3>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold mb-2">14. 빈 입력 시각 신호</h3>
        <ul className="list-disc pl-5 space-y-1">
